!function() {
    ...
    e.prototype = {
        ...
        _autoResume: function() {
            var e = this;
            return e.ctx && void 0 !== e.ctx.resume && n.usingWebAudio ? ("running" === e.state && e._suspendTimer ? (clearTimeout(e._suspendTimer),
    ...
    o.prototype = {
        ...
        _startFadeInterval: function(e, n, o, t, r) {
            ...
            e._interval = setInterval(function() {
                ...
                (n > o && o >= u || o > n && u >= o) && (clearInterval(e._interval),
                e._interval = null,
                a.volume(o, e._id),
                a._emit("fade", e._id))
            }, s)
...
function() {
    function isNotesMarked() {
        collectAllNotes[0] && (Object.values(collectAllNotes[0]).length >= 1 ? ($(".btn-reset").removeClass("hidden"),
        $(".playAll").removeClass("hidden")) : ($(".btn-reset").addClass("hidden"),
    ...
    function markNotes(key) {
        if (!markTrigger) {
            ...
            lockEvent[currentKey] || key.toggleClass("marked").promise().done(function() {
                ...
                $(this).hasClass("marked") ? (tempObjNote[currentKey] = currentKey,
                collectAllNotes[0] = tempObjNote,
                collectNotesToArr = Object.values(tempObjNote)) : (delete collectAllNotes[0][currentKey],
    ...
    function playMarkedNotes() {
        var allMarkedNotes = document.querySelectorAll(".marked > span")
          , isActiveMarkedNotes = [];
        allMarkedNotes.length >= 2 ? Howler.volume(.8) : Howler.volume(1),
    ...
    function parseURLParams(url) {
        var i, n, v, nv, queryStart = url.indexOf("?") + 1, queryEnd = url.indexOf("#") + 1 || url.length + 1, query = url.slice(queryStart, queryEnd - 1), pairs = query.replace(/\+/g, " ").split("&"), parameters = {}, elements = [];
        if (query !== url && "" !== query) {
    ...
    }, lockEvent = {}, i = 0; 256 > i; i++)
        lockEvent[i] = !1;
    var lastPlaying, counter, lastAudioArr = [], lastPlayingArr = [], keyCharBank = PIANO_TRANSLATION.keys, keys = {};
    ...
    $(window).bind("keydown keyup", function(ev) {
        ...
        "keydown" == ev.type && note ? lockEvent[keyNo] || (lastPlaying = note.play(),
        ...
        markTrigger || markNotes($key)) : "keyup" == ev.type && (lockEvent[keyNo] = !1,
        $key.removeClass("active"),
        $key.parent().removeClass("active"),
        isNotesMarked()),
        "keydown" == ev.type && 32 === ev.keyCode ? (ev.preventDefault(),
        spacebarPressed || (playMarkedNotes(),
        spacebarPressed = !0)) : "keyup" == ev.type && 32 === ev.keyCode && (spacebarPressed = !1)
    });
    var markTrigger = !0
      , collectAllNotes = []
      , collectNotesToArr = []
